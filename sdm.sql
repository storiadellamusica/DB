...
CREATE TABLE `phpbb_users` (
  ...
  `user_unread_privmsg` int(11) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sdmt_classifica_decennio` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `recensione_id` int(11) DEFAULT NULL,
  `Artista` int(11) DEFAULT NULL,
  `decennio` int(4) DEFAULT NULL,
  `posizione` int(3) DEFAULT NULL,
  `discogs` varchar(20) DEFAULT NULL,
  `uscita` int(4) DEFAULT NULL,
...
CREATE TABLE `sdmt_news` (
  ...
  `id_autore` int(11) unsigned DEFAULT NULL,
  `artista` varchar(255) NOT NULL DEFAULT '',
  `genere` text NOT NULL,
  `kws` text NOT NULL,
  `bozza` int(1) unsigned NOT NULL DEFAULT '1',
  `pubblicato` int(1) unsigned NOT NULL DEFAULT '0',
  `modificata` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
CREATE TABLE `sdmt_news_copy` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `url` varchar(255) NOT NULL,
  `titolo` varchar(255) NOT NULL DEFAULT '',
  `data` int(11) unsigned NOT NULL,
...
CREATE TABLE `sdmt_privilegi` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `utente` int(11) unsigned NOT NULL,
  `privilegio` int(11) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
CREATE TABLE `sdmt_recensioni` (
  `ID` int(25) NOT NULL AUTO_INCREMENT,
  `url` varchar(255) NOT NULL DEFAULT '',
  `url_etichetta` varchar(255) NOT NULL,
  `Num` int(5) DEFAULT NULL,
  `Titolo_Disco` varchar(255) DEFAULT NULL,
  `Titolo` varchar(255) DEFAULT NULL,
  `Autore` varchar(255) DEFAULT NULL,
  ...
  `discogs` varchar(255) NOT NULL DEFAULT '',
  `itms_album_id` int(20) DEFAULT '0',
  `tracks` mediumtext,
  `myspace` varchar(255) DEFAULT NULL,
  `homepage` varchar(255) DEFAULT NULL,
  `terzolinktesto` varchar(255) DEFAULT NULL,
  `terzolink` varchar(255) DEFAULT NULL,
  `youtube` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `Genere1` (`Genere1`),
  KEY `url` (`url`),
  KEY `url_etichetta` (`url_etichetta`),
  FULLTEXT KEY `Titolo` (`Titolo`,`kws`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
CREATE TABLE `sdmt_tracks` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `artista_id` int(20) DEFAULT NULL,
  `recensione_id` int(20) DEFAULT NULL,
  `itms_album_id` int(20) DEFAULT NULL,
  `itms_track_id` int(20) DEFAULT NULL,
  `itms_artist_id` int(20) DEFAULT NULL,
...
CREATE TABLE `sdmt_user_proposte` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `titolo` varchar(255) NOT NULL DEFAULT '',
  ...
  `urgenza` int(1) NOT NULL DEFAULT '0',
  `autore` varchar(255) NOT NULL DEFAULT '',
  `mipiace` text NOT NULL,
  `nonmipiace` text NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
CREATE TABLE `sdmt_user_proposte_commenti` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `collegato` int(11) NOT NULL,
  `autore` varchar(255) NOT NULL DEFAULT '',
  `testo` text NOT NULL,
  `data` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
